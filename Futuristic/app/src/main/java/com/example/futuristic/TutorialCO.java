...
public class TutorialCO extends SupportPage{

    private ViewPager mSlideViewPager;
    private LinearLayout mDotLayout;
    private TextView[] mDots;
    private TutorialCOAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderAdapter = new TutorialCOAdapter(this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(TutorialCO.this, SupportHow.class)
                .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK)
                .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        customType(TutorialCO.this, "right-to-left");
    }
}
