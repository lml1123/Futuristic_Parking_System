...
public class TutorialR extends SupportPage{

    private ViewPager mSlideViewPager;
    private LinearLayout mDotLayout;
    private TextView[] mDots;
    private TutorialRAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderAdapter = new TutorialRAdapter(this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(TutorialR.this, SupportHow.class)
                .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK)
                .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        customType(TutorialR.this, "right-to-left");
    }
}
