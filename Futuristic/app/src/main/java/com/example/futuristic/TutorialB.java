...
public class TutorialB extends SupportPage{

    private ViewPager mSlideViewPager;
    private LinearLayout mDotLayout;
    private TextView[] mDots;
    private TutorialBAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderAdapter = new TutorialBAdapter(this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(TutorialB.this, SupportHow.class)
                .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK)
                .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        customType(TutorialB.this, "right-to-left");
    }
}
